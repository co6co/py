<template>
  <!-- 弹出框 -->
  <el-dialog :title="form.title" v-model="form.dialogVisible" style="width: 50%; height: 80%">
    <el-form
      label-width="90px"
      ref="dialogForm"
      :rules="rules"
    ...
    >
      ...
      <el-form-item label="通道1" prop="channel1_sip">
        <el-input v-model="form.fromData.channel1_sip" placeholder="通道1地址"></el-input>
      </el-form-item>
      <el-form-item label="通道2" prop="channel2_sip">
        <el-input v-model="form.fromData.channel2_sip" placeholder="通道2地址"></el-input>
      </el-form-item>

      <el-form-item label="通道3" prop="channel3_sip">
        <el-input v-model="form.fromData.channel3_sip" placeholder="通道3地址"></el-input>
      </el-form-item>

      <el-form-item label="通道4" prop="channel4_sip">
        <el-input v-model="form.fromData.channel4_sip" placeholder="通道4地址"></el-input>
      </el-form-item>

      <el-form-item label="通道5" prop="channel5_sip">
        <el-input v-model="form.fromData.channel5_sip" placeholder="通道5地址"></el-input>
      </el-form-item>
  ...
  formEl.validate((value) => {
    if (value) {
      ...
      if (form.operation == 0) {
        ...
        api
          .edit_camera_svc(form.id, form.fromData)
          .then((res) => {
            if (res.code == 0) {
              form.dialogVisible = false
