<template>
	...
	<div class="container-layout">
		<el-container>
			<el-header>
				<div class="handle-box">
					<el-select style="width: 160px" class="mr10" clearable v-model="table_module.query.alarmType"
						placeholder="告警类型">
						<el-option v-for="(item, index) in table_module.categoryList" :key="index" :label="item.desc"
					...
					<div class="el-select mr10">
						<el-date-picker style="margin-top: 3px" v-model="table_module.query.datetimes"
							...
							range-separator="至" start-placeholder="开始时间" end-placeholder="结束时间" title="告警时间" />
					...
					<el-button type="info" v-show="false"
						@click="table_module.moreOption = !table_module.moreOption">更多<el-icon :is="moreIcon">
							<component :is="moreIcon"></component>
						</el-icon></el-button>
				</div>
			...
			<el-main>
				<el-scrollbar>
					...
					<el-table highlight-current-row @sort-change="onColChange" :row-class-name="tableRowProp"
						...
						<el-table-column prop="uuid" label="ID" width="130" align="center" sortable
						...
						<el-table-column label="任务类型" width="110" sortable prop="flowStatus">
							<template #default="scope">
								<el-tag>{{ scope.row.taskSession }}--{{ scope.row.taskDesc }}
								</el-tag></template>
						</el-table-column>
		...
		<!-- 弹出框 -->
		<el-dialog title="详细信息" v-model="form.dialogVisible" style="width: 80%; height: 76%" @keydown.ctrl="keyDown">
