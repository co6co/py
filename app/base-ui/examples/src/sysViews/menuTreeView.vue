...
import modifyDiaglog, { type Item } from '../components/sys/modifyMenu'
import { showLoading, closeLoading } from '../components/Logining'
import useSelect, { useMenuCategory, useMenuState } from '../hook/sys/useMenuSelect'
...
const onOpenDialog = (operation: api_types.FormOperation, row?: Item) => {
  table_module.diaglogTitle = operation == api_types.FormOperation.add ? '增加新菜单' : '编辑菜单'
