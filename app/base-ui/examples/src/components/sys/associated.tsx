...
export type FormItem = api_type.IAssociation

/**
 * 关联模型
 */
export type AssociatedSelect = api_type.ITreeSelect & { associatedValue: number | boolean }
export type get_svc = (
  associatedId: number,
  data: any
) => Promise<api_type.IResponse<AssociatedSelect[]>>
...
interface FormTree {
  treeSelectData: api_type.ITreeSelect[]
