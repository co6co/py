...
from ..view_model.dict.dictView import Views, View, DictExistView
from co6co_sanic_ext.api import add_routes

dict_api = Blueprint("dict_API", url_prefix="/dict")
add_routes(dict_api, Views, View, DictTypeViews, DictTypeView)
add_routes(dict_api,   DictTypeExistView, DictExistView)
