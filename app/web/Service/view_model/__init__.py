...
class ImportView(AuthMethodView, AbsImport):
    ...
    async def _post(self,  orient: Literal['dict', 'list', "series", 'index', 'records', 'split'] = "records"):
        """
        ...
        try:
            ...
            insertNum, uploadNum, errorNUm, msg = await self.importData(file.body, orient=orient,  dbSession=dbSession)
