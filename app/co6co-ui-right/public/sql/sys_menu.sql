...
INSERT INTO `sys_menu` (`id`,`parent_id`,`category`,`icon`,`name`,`code`,`url`,`component`,`methods`,`permission_key`,`order`,`status`,`remark`,`create_user`,`update_user`,`create_time`,`update_time`) VALUES ('61', '25', '1', null, '资源', 'sys_resource', '/v1/api/resource/**', null, 'ALL', null, '1', '0', null, '1', null, '2024-04-29 09:48:57', null);
