<template>
	<div class="container-layout">
		<el-container>
			<el-header>
				<div class="handle-box">
					<el-input v-model="table_module.query.name" placeholder="站点名称" class="handle-input mr10"></el-input>
			...
			<el-main>
              ...
              <el-table-column prop="deviceCode" label="设备代码" width="120" align="center" sortable
							:show-overflow-tooltip="true"></el-table-column>

              <el-table-column prop="deviceDesc" label="用途" width="120" align="center" sortable
							:show-overflow-tooltip="true"></el-table-column>

              <el-table-column prop="postionInfo" label="安装位置" width="120" align="center" sortable
							:show-overflow-tooltip="true"></el-table-column>
        ...
        <el-form-item label="用途" prop="deviceDesc"> 
          <el-input v-model="form.fromData.deviceDesc" type="textarea" placeholder="安装用途，抓拍描述等" />
				</el-form-item>
			</el-form>
			<template #footer>
...
import {
  ...
  Plus,
  Minus,
  Message, Cpu, VideoCamera,Setting
...
const onOpenConfigPage = (category: string, row: TableRow) => { 
  api.getDetailInfo(row.id, category).then((res) => {
    if (res.code == 0) {
      ...
      else window.open(`https://www.baidu.com/s?wd=${data[0].data.name}`, '_blank');
    }
  });
};
</script>
