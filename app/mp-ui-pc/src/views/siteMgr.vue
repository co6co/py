<template>
	<div class="container-layout">
					...
					<el-table highlight-current-row @sort-change="onColChange" :row-class-name="tableRowProp"
						...
						<el-table-column label="操作" align="center">
							<template #default="scope">
								...
								<el-button text :icon="Cpu" @click="onOpen2Dialog('box', scope.row)">
									盒子信息
								</el-button>
								<el-button text :icon="VideoCamera" @click="onOpen2Dialog('ip_camera', scope.row)">
									违停球信息
								</el-button>
							</template>
						</el-table-column>
		...
		<!-- 弹出框 -->
		<el-dialog :title="form.title" v-model="form.dialogVisible" @keydown.ctrl="keyDown">
		...
		<!-- 弹出框 -->
		<el-dialog :title="form2.title" v-model="form2.dialogVisible" style="width:70%; height:76%;" @keydown.ctrl="keyDown">
			<el-row>
				<el-col >
					<el-scrollbar >
