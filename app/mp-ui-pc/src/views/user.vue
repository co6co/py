				...
				<el-card shadow="hover">
					...
					<el-form label-width="90px" :model="changePwdFrom" :rules="changePwdRules" ref="Form">
						...
						<el-form-item label="新密码：" prop="newPassword">
							<el-input type="password" v-model="changePwdFrom.newPassword"></el-input>
						</el-form-item>
						<el-form-item label="个人简介：" prop="remark">
							<el-input v-model="changePwdFrom.remark"></el-input>
						</el-form-item>
						<el-form-item>
...
const changePwdRules: FormRules ={ 
	...
	newPassword: [{ required: true, min:6 ,max:20, message: '请输入6-20位新密码', trigger:  ['blur',"change"] }] ,
	...
	formEl.validate(value=>{
		if(value){
			changePwd_svc(changePwdFrom).then(res=>{
				...
				else {ElMessage.error(`修改密码失败:${res.message}`);}
			}) 
		}
	}) 
};
