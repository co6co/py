	...
	const onOperater = (name: string, type: number) => {
		switch (name) {
			...
			case 'zoomout':
				...
				break;
			case 'center':
				type == 1 ? emits('centered') : emits('centering');
				break;
			default:
				return;
		}
