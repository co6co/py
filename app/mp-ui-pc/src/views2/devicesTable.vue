            ...
            <el-row :gutter="24" v-if="table_module.moreOption">
                <div class="handle-box">
                    <div class="el-select mr10">
                        <el-link type="info" @click="setDatetime(0, 0.5)"
                            >0.5h内</el-link
                        >
                        <el-link type="info" @click="setDatetime(0, 1)"
                            >1h内</el-link
                        >
                        <el-link type="info" @click="setDatetime(1, 24)"
                            >今天</el-link
                        >
                        <el-date-picker
                    ...
                    <el-table-column label="操作" width="316" align="center">
                        <template #default="scope">
                            <el-button
                                ...
                                :icon="Edit"
                                @click="
                                    onOpenPage('/alarmdetail.html', scope.row)
                                "
                            >
                                详细信息
                            </el-button>
                            <el-button
                                ...
                                :icon="Edit"
                                @click="
                                    onOpenPage('/alarmpreview.html', scope.row)
                                "
                            >
                                告警视频
                            </el-button>
